...
require_once __DIR__ . '\..\..\model\util\dao\OrderRecordDao.php';

class OrderRecordDaoTest extends \Codeception\Test\Unit
{
    private $iterate;
    private $obj;
    private $queryStr;
    ...
    public function testAddNotOrderRecordExpectInvalidArgumentException()
    {
        $object = "test";
    ...
    public function testAddOrderRecordExpectAction()
    {
        $user_id = 14;
        $product_id = 16;
        $count = 2;
    ...
    public function testUpdateNotOrderRecordExpectInvalidArgumentException()
    {
        $object = "test";
        $db = $this->createMysqliQuerySpy(null);
        $dao = new OrderRecordDao($db);
    ...
    public function testUpdateOrderRecordExpectAction()
    {
        $id = 12;
        $user_id = 14;
        $product_id = 16;
        ...
        $phone = "1234567";
        $order_date = '2018-01-01';
        $object = new OrderRecord($id, new User($user_id, "aaaaaaa",
            "aswer@test.se", "12345678"), new Product($product_id,
            "namename", new Category(123, "lalala"), 143,
            "lalala"), $count,
            $address, $phone, $order_date);
    ...
    public function testGetAllFromEmptyTableExpectEmptyArray()
    {
        ...
        $this->generateMysqliStub($this->mysqliResultStub,
            "SELECT * FROM `log` WHERE `confirm_date` IS NULL");
        $dao = new OrderRecordDao($this->mysqliStub);
        $expected = array();
        $actual = $dao->getAll();
    ...
    public function testGetAllFromNonEmptyTableExpectArrayWithObject()
    {
        ...
        $this->generateMysqliStub($this->mysqliResultStub,
            "SELECT * FROM `log` WHERE `confirm_date` IS NULL");
        $dao = $this->construct(OrderRecordDao::class, [$this->mysqliStub],
